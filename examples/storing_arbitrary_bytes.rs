...
async fn main() -> Result<()> {
	let mut lightbulb = LightbulbAccessory::new(
		1,
		AccessoryInformation { name: "Acme Stateful Lightbulb".into(), ..Default::default() },
	)?;
	...
	// TODO - creating another FileStorage instance on the same underlying directory isn't that
	// elegant
