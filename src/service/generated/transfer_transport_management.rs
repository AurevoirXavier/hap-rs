	...
	pub fn new(id: u64, accessory_id: u64) -> Self {
		Self {
			...
			supported_transfer_transport_configuration:
				SupportedTransferTransportConfigurationCharacteristic::new(id + 1, accessory_id),
...
impl HapService for TransferTransportManagementService {
	...
	fn get_characteristics(&self) -> Vec<&dyn HapCharacteristic> {
		...
		let mut characteristics: Vec<&dyn HapCharacteristic> =
			vec![&self.supported_transfer_transport_configuration, &self.setup_transfer_transport];
		characteristics
	}
