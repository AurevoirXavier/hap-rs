...
/// [`FileStorage`](FileStorage) is an implementor of the [`Storage`](Storage) trait that stores
...
mod tests {
	...
	async fn test_pairing_storage() {
		...
		// a fresh file storage should count 0 pairings, list an empty Vec, and error on a
		// non-existent ID
